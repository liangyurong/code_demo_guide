...
public class IOUtilsController {
    ...
    public void deleteAllFileInCatalog(){
        String catalogPath = "D:\\羽绒333\\code_demo_guide\\src\\main\\resources\\temp";
        boolean b = IOUtils.deleteAllFileInCatalog(catalogPath);
    ...
    public String testGetFileNameFromClient(@RequestBody MultipartFile multipartFile){
        ...
        return  IOUtils.getFileNameFromClient(multipartFile);
    }
